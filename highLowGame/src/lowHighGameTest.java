...
public class lowHighGameTest {
	...
	lowHighGame myRandomNumber = new lowHighGame();
	...
	while (userNotDone)
	{
		...
		if (choice == 1) 
		{
		    ...
		    do {     
		    	...
		    	String input3 = JOptionPane.showInputDialog("Welcome to the guess a number game, please type in a number between 0 and high number\n");  	
				
		    	int user = Integer.parseInt( input3 );		
		    	
		    	int game=myRandomNumber.GetANumber(user); 
